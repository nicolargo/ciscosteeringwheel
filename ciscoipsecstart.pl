...
# conf t > Interface > crypto map MAPNAME
#
# Syntaxe: ./ciscoipsecstart.pl -a <Cisco IP address/name> -u <login> -p <password> -P <enablepassword> -i <interface> -m <MAPNAME>
# Example: ./ciscoipsecstart.pl -a 192.168.254.14 -u login -p "password1" -P "password2" -i "FastEthernet0/1" -m "TAMCMAP"
#
...
#
#==================================================
my $program_name = "ciscoipsecstart.pl";
...
if ($session->enable($enablepassword) ) {
	...
	ciscocommand("crypto map ".$mapname);
} else {
